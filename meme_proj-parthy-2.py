...
humour_col = lbl_enc.fit_transform(data.Humour.values)
...
X_train_humour, X_test_humour, y_train_humour, y_test_humour = train_test_split(data.Corrected_text.values, humour_col, random_state=42, test_size=0.1, shuffle=True)
